...
# Standardise all numeric variables to avoid large variance disparities
num_cols_all <- names(df_sem)[sapply(df_sem, is.numeric)]
df_sem[num_cols_all] <- scale(df_sem[num_cols_all])
